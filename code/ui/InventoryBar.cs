...
public class InventoryBar : Panel
{
	...
	List<BaseStrifeWeapon> Weapons = new();

	public bool IsOpen;
	BaseStrifeWeapon SelectedWeapon;
	...
	public override void Tick()
	{
		...
		Weapons.Clear();
		Weapons.AddRange( player.Children.Select( x => x as BaseStrifeWeapon ).Where( x => x.IsValid() && x.IsUsable() ) );
	...
	public void ProcessClientInput( InputBuilder input )
	{
		...
		if ( IsOpen != wantOpen )
		{
			SelectedWeapon = Local.Pawn.ActiveChild as BaseStrifeWeapon;
			IsOpen = true;
		}
	...
	int NextInBucket()
	{
		...
		BaseStrifeWeapon first = null;
		BaseStrifeWeapon prev = null;
