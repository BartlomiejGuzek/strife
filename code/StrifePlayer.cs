...
partial class StrifePlayer : Player
{
	...
	public override void Simulate( Client cl )
	{
		...
		//
		if ( ActiveChild is BaseStrifeWeapon weapon && !weapon.IsUsable() && weapon.TimeSincePrimaryAttack > 0.5f && weapon.TimeSinceSecondaryAttack > 0.5f )
		{
			SwitchToBestWeapon();
		}
	}
	...
	{
		var best = Children.Select( x => x as BaseStrifeWeapon )
